...
\section{Experience}
  ...
  \resumeSubheading
  {\href{https://www.manta.network/}{\underline{Manta Network}} $|$ \small{Full Stack Engineer}}{Sept 2022 -- Current}
    {Using ZKP to build On-Chain Privacy for Web3, Defi, and More}{Remote}
    \resumeItemListStart
      \resumeItem{Contributed mainly to dapp's frontend repo building UI for staking and token bridge page}
      \resumeItem{Built dashboard to enable core features including stake/unstake rule and reward display for chain's staking page}
      \resumeItem{Redesigned wallet connection component to improve UX and support more wallet options including Metamask}
      \resumeItem{Initialized the refactoring process of integrating typescript and Selenium's test automation into the frontend repo}
      \resumeItem{Tech Stack: React, Rust, Typescript, Tailwind, Polkadot JS, Web3.js}
    \resumeItemListEnd
